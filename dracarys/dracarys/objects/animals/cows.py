...
class Cows(Character):
    def __init__(self, game: Game):
        super(Cows, self).__init__(game)
        ...
        # Sprite
        image_source_1 = "objects/images/cow-1.png"
        image_source_2 = "objects/images/cow-2.png"
        image_source_3 = "objects/images/cow-3.png"
        self.sprite_1 = arcade.Sprite(
            image_source_1,
        ...
        #     center_y=self.body.position.y,
        # )
        self.game.ui_manager.scene.add_sprite("Player", self.sprite_1)
        # self.game.ui_manager.scene.add_sprite("Player", self.sprite_2)
        # self.game.ui_manager.scene.add_sprite("Player", self.sprite_3)

    def draw(self):
        """Used to draw self onto arcade scene."""
        # sprite_list = [self.sprite_1, self.sprite_2, self.sprite_3]
        # index = randrange(2)

        self.sprite_1.position = self.body.position
        self.sprite_1.radians = self.body.angle
